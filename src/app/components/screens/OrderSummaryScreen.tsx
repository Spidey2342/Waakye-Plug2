...
export function OrderSummaryScreen({ onBack, onConfirm }: OrderSummaryScreenProps) {
  ...
  // The "base" or "combo" item is treated as the headline item for a line;
  // everything else (proteins/extras) is a modifier shown underneath.
            ...
            <div className="max-w-2xl mx-auto p-4 space-y-4">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button disabled className="p-4 rounded-xl border-2 border-gray-200 bg-gray-50 cursor-not-allowed opacity-60">
              ...
              >
                <p className="text-sm text-gray-700">
                  📝 Your order will be confirmed via Snapchat or WhatsApp. We'll send you pickup/delivery details!
                </p>
              </motion.div>
            </div>
          </div>
